...
public class Resources {
    ...
    private void saveScoreEntries() throws IOException {
    	try {
	    	PrintWriter out = new PrintWriter("res/highscores.txt");
    ...
    private void loadScoreEntries() {
    	try {
            BufferedReader bufferreader = new BufferedReader(new FileReader("res/highscores.txt"));
            String line = bufferreader.readLine();
            while (line  != null) {
            	ScoreEntry newEntry = ScoreEntry.read(line);           	
            	addScoreEntry(newEntry);
